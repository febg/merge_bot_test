...
class Analyzer {
    ...
    */
    ...
    private func analyzeFileCoverage3(targetFiles: [[String: Any]], files: [String], targetLines: Double) -> [FileCoverageResult]? {
        var fileReports = [FileCoverageResult]()
        var fileDetected = false
        for file in targetFiles {
            let fileName = file["name"] as! String
        ...
        private func analyzeFileCoverage4(targetFiles: [[String: Any]], files: [String], targetLines: Double) -> [FileCoverageResult]? {
        var fileReports = [FileCoverageResult]()
        var fileDetected = false
        for file in targetFiles {
            let fileName = file["name"] as! String
        ...
        private func analyzeFileCoverage5(targetFiles: [[String: Any]], files: [String], targetLines: Double) -> [FileCoverageResult]? {
        var fileReports = [FileCoverageResult]()
        var fileDetected = false
        for file in targetFiles {
            let fileName = file["name"] as! String
        ...
        private func analyzeFileCoverage6(targetFiles: [[String: Any]], files: [String], targetLines: Double) -> [FileCoverageResult]? {
        var fileReports = [FileCoverageResult]()
        var fileDetected = false
        for file in targetFiles {
            let fileName = file["name"] as! String
